...
$resultUsers = $koneksi->query("SELECT COUNT(*) AS total_users FROM users");
$rowUsers = $resultUsers->fetch_assoc();
$totalUsers = $rowUsers['total_users'];

// Query untuk menghitung jumlah produk
$resultProduk = $koneksi->query("SELECT COUNT(*) AS total_produk FROM produk");
$rowProduk = $resultProduk->fetch_assoc();
$totalProduk = $rowProduk['total_produk'];
...
<head>
    ...
    <title>Astore Admin - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Astore</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-3 collapse-inner rounded">
                        <a class="collapse-item" href="about_us.php">Profil Admin</a>
                        <a class="collapse-item" href="produk.php">Produk</a>
                        <a class="collapse-item" href="kelola_pesanan.php">Kelola Pesanan</a>
                    </div>
                </div>
            </li>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-users fa-2x text-gray-300"></i> <!-- Updated icon -->
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalProduk; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-boxes fa-2x text-gray-300"></i> <!-- Updated icon -->
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-user-tie fa-2x text-gray-300"></i> <!-- Updated icon -->
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>&copy; 2024 Astore. All Rights Reserved.</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
